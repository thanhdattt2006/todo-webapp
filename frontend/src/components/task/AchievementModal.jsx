                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {achievements.map((task, index) => (
                          <div 
                            ...
                            className="relative group bg-white/5 hover:bg-white/10 p-5 rounded-2xl border border-white/10 hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-yellow-500/10 backdrop-blur-sm cursor-pointer"
                          >
                            ...
                            <div className="flex items-center gap-4 text-xs text-gray-400">
                              <span className="flex items-center gap-1.5 bg-black/30 px-2.5 py-1 rounded-full">
                                ...
                                {formatDate(task.updatedAt || new Date(), currentLang)} - {t('completedLabel')}
                              </span>
